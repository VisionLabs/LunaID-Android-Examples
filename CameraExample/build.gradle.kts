...
dependencies {
    ...
    implementation("ai.visionlabs.lunaid:core:1.7.1@aar")
    implementation("ai.visionlabs.lunaid:cnn52:1.7.1@aar")
    implementation("ai.visionlabs.lunaid:cnn59:1.7.1@aar")
    implementation("ai.visionlabs.lunaid:mask:1.7.1@aar")
