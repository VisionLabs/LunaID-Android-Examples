...
//    implementation("ai.visionlabs.lunaid:glasses-x86:$sdkVersion@aar")
    ...
    implementation(files("libs/lunaid-core-3303c6e7.aar"))
    implementation(files("libs/lunaid-cnn52-arm-3303c6e7.aar"))
    implementation(files("libs/lunaid-cnn59-arm-3303c6e7.aar"))
    implementation(files("libs/lunaid-common-arm-3303c6e7.aar"))
    implementation(files("libs/lunaid-glasses-arm-3303c6e7.aar"))
    implementation(files("libs/lunaid-mask-arm-3303c6e7.aar"))
    implementation(files("libs/lunaid-oslm-arm-3303c6e7.aar"))
